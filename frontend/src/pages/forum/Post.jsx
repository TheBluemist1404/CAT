    ...
    if (commentInput.trim()) {
      if (!isLoggedIn) {
        ...
        await fetch(
          token,
          axios.post(
            `${import.meta.env.VITE_APP_API_URL}/api/v1/forum/comment/${
              post._id
            }`,
    ...
    <div className="post">
      <div className="post-header">
        <img
          ...
          onClick={() => {
            navigate(`/profile/${post.userCreated._id}`);
          }}
        ...
        <div
          ...
          style={{ cursor: "pointer" }}
        >
          {post.userCreated ? post.userCreated.fullName : "unknown"}
        </div>
        <div
          className="post-time"
          onMouseDown={() => {
        ...
        <div className="comment-section" style={{ padding: "10px" }}>
          ...
          <div className="create-comment">
            <div className="create-comment-header">
              ...
              >
                <img
                  src={!isLoggedIn ? defaultAvatar : user.avatar}
                  className="comment-avatar"
                  alt="Avatar"
                  style={{ width: "40px" }}
                />
